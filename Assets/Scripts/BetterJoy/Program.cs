...
namespace BetterJoyForCemu {
                ...
                if (validController && !ControllerAlreadyAdded(enumerate.path)) {
                    ...
                    /*if (Program.useHIDG) {
                        ...
                        try {
                            ...
                            UnityEngine.Debug.Log("Unable to add controller to block-list.\r\n"); //form.AppendTextBox("Unable to add controller to block-list.\r\n");
                        }
                    }*/
                    // -------------------- //
    ...
    class Program {
        ...
        static public bool useHIDG = false; //Boolean.Parse(ConfigurationManager.AppSettings["UseHIDG"]);
        ...
        public static void Start() {
            ...
            UnityEngine.Debug.Log("Program start");
            /*if (useHIDG) {
            ...
            server.Start(IPAddress.Parse("127.0.0.1"), Int32.Parse("26760"));
            ...
            UnityEngine.Debug.Log("All systems go\r\n"); //form.console.AppendText("All systems go\r\n");
        }

        private static void Mouse_MouseEvent(System.Object sender, WindowsInput.Events.Sources.EventSourceEventArgs<WindowsInput.Events.Sources.MouseEvent> e) {
            if (e.Data.ButtonDown != null) {
                ...
                if (res_val.StartsWith("mse_"))
                    if ((int)e.Data.ButtonDown.Button == Int32.Parse(res_val.Substring(4)))
                        WindowsInput.Simulate.Events().MoveTo(System.Windows.Forms.Screen.PrimaryScreen.Bounds.Width / 2, System.Windows.Forms.Screen.PrimaryScreen.Bounds.Height / 2).Invoke();
        ...
        private static void Keyboard_KeyEvent(System.Object sender, WindowsInput.Events.Sources.EventSourceEventArgs<WindowsInput.Events.Sources.KeyboardEvent> e) {
        ...
        public static void Stop() {
            UnityEngine.Debug.Log("Program stop");
            if (Program.useHIDG) {
                try {
                    ...
                    UnityEngine.Debug.Log("Unable to remove program from whitelist.\r\n"); //form.console.AppendText("Unable to remove program from whitelist.\r\n");
                }
            }

            if (true && Program.useHIDG) {
                try {
